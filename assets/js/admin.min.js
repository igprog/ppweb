angular.module('app', []).config(['$httpProvider', function ($httpProvider) {
    ...
    $scope.loadActivityLog = function () { $scope.activeTab = 'activityLog'; $scope.loading = true; functions.post('Log', 'Load', { fileName: 'activity.log' }).then(function (d) { $scope.activityLog = d; loadLoginLog(); $scope.loading = false; }); }
    var loadLoginLog = function () { $scope.loading = true; functions.post('Log', 'LoadLoginLog', {}).then(function (d) { $scope.loginLog = d; $scope.loading = false; }); }
